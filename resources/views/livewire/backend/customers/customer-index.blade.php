    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-1">
            <div class="breadcrumbs mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Kunden</h1>
        ...
        @if(count($customers) > 0)
            <x-ag.table.table>
                <x-slot:thead>
                    ...
                    <x-ag.table.th>Straße</x-ag.table.th>
                    <x-ag.table.th>PLZ / Ort</x-ag.table.th>
                    <x-ag.table.th>Telefon / Mobil</x-ag.table.th>
                    <x-ag.table.th>E-Mail</x-ag.table.th>
                ...
                <x-slot:tbody>
                    @forelse($customers as $key => $customer)
                        <x-ag.table.tr class="text-sm">
                            ...
                            <td class="p-2 text-right">
                                ...
                                @endcan
                                @can('delete')
                                    <x-ag.button.link wire:click="$emit('triggerDelete',{{ $customer->id }})" class="px-2 text-red-500 hover:text-red-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                    ...
                    @empty
                        <x-ag.table.tr>
                            <td colspan="9" class="p-2 text-center font-bold text-lg">Es wurde noch keine Kunden angelegt.</td>
                        </x-ag.table.tr>
                   @endforelse
                </x-slot:tbody>
            </x-ag.table.table>
