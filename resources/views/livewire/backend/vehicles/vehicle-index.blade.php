    ...
    <div class="p-4 bg-white block lg:flex items-center justify-between border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-1">
            <div class="breadcrumbs mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 lg:text-2xl dark:text-white">Fahrzeuge</h1>
    ...
    <x-ag.main.head>
        ...
        <x-ag.table.table>
            ...
            <x-slot:tbody>
                ...
                @empty
                    <x-ag.table.tr>
                        <td colspan="9" class="p-2 text-center font-bold text-lg">Es wurden noch keine Fahrzeuge
                            angelegt.
                        </td>
                    </x-ag.table.tr>
                @endforelse
