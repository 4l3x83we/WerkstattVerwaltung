<div>
    <div class="grid grid-cols-1 p-4 pb-0 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
        <div class="mb-4 col-span-full xl:mb-2">
            <div class="breadcrumbs">
                {!! Breadcrumbs::render('offerCreate') !!}
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Neues Angebot erstellen</h1>
    ...
    <x-ag.main.head>
        ...
        <form wire:submit.prevent="store" method="POST" class="p-4">
            <input type="hidden" wire:model="offers.id">
            <div class="grid grid-cols-1 xl:grid-cols-2 xl:gap-4 dark:bg-gray-900">
                {{-- Left --}}
                @include('livewire.backend.office.offer.office-forms-anschrift')
                {{-- Right --}}
                @include('livewire.backend.office.offer.office-forms-fahrzeug')
            </div>
            @include('livewire.backend.office.offer.office-forms-positionen')
