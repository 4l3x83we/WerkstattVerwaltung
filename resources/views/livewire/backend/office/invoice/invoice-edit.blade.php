    ...
    <div class="grid grid-cols-1 p-4 pb-0 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
        <div class="mb-4 col-span-full xl:mb-2">
            <div class="breadcrumbs">
                {!! Breadcrumbs::render('invoiceEdit', $offen) !!}
                <h1 class="text-xl font-semibold text-gray-900 lg:text-2xl dark:text-white">Rechnung bearbeiten
                    ({{ $offen->invoice_nr }})</h1>
                    ...
                    <x-ag.card.head>
                        ...
                        <div class="grid grid-cols-12 gap-4 mt-4">
                            <div class="col-span-12 lg:col-span-6">
                                <x-ag.forms.inline-label-input id="offen.invoice_nr" text="Rechnungs-Nr." readonly/>
                            </div>
                            <div class="col-span-12 lg:col-span-6">
                                <x-ag.forms.inline-label-input type="date" id="offen.invoice_date" text="Datum" readonly/>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-12 gap-4 mt-4">
                            <div class="col-span-12 lg:col-span-6">
                                <x-ag.forms.textarea id="offen.invoice_notes_1" rows="5" text="Auftragstext"/>
                            </div>
                            <div class="col-span-12 lg:col-span-6">
                                <x-ag.forms.textarea id="offen.invoice_notes_2" rows="5" text="Rechnungstext"/>
                            </div>
                        </div>

                        <div class="grid grid-cols-12 gap-4 mt-4">
                            <div class="col-span-12 lg:col-span-6">
                                <x-ag.forms.inline-label-input type="date" id="offen.delivery_performance_date" text="Liefer-/ Leistungsdatum"/>
                            </div>
                            <div class="col-span-12 lg:col-span-6">
                                <x-ag.forms.inline-select id="offen.invoice_clerk" text="Sachbearbeiter/in">
