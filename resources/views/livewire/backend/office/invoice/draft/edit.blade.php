    ...
    <div class="grid grid-cols-1 p-4 pb-0 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
        <div class="mb-4 col-span-full xl:mb-2">
            <div class="breadcrumbs">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Rechnungsentwurf bearbeiten ({{ $draft->order_nr }})</h1>
                    ...
                    <x-ag.card.head>
                        <div class="w-2/3">
                            <ol class="flex items-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
                                ...
                                <li class="flex md:w-full items-center text-orange-600 dark:text-orange-500 after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-700">
                        ...
                        <div class="grid grid-cols-12 gap-4 mt-4">
                            <div class="col-span-12 sm:col-span-6">
                                <x-ag.forms.inline-label-input id="order.order_nr" text="Rechnungs-Nr." readonly/>
                            </div>
                            <div class="col-span-12 sm:col-span-6">
                ...
                <div class="col-span-2">
                    <x-ag.card.head>
                        <div class="space-y-2">
                            ...
                            <x-ag.button.button class="w-full justify-center" wire:click="deposit({{ $draft->id }})">Anzahlung</x-ag.button.button>
                            <x-ag.button.button class="w-full justify-center !text-red-700 !border-red-700 !hover:bg-red-800 !focus:ring-red-300 !dark:border-red-500 !dark:text-red-500 !dark:hover:bg-red-600 !dark:focus:ring-red-900" wire:click="remove({{ $draft->id }})">Auftrag Löschen</x-ag.button.button>
                        </div>
                        <hr class="my-2">
