        ...
        <div class="w-full mb-1">
            <div class="breadcrumbs mb-4">
                ...
                <div class="inline-flex items-center">
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white mr-4">Aufträge</h1>
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 mb-4">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                    <li class="mr-2">
                        <a href="{{ route('backend.invoice.order.index-order') }}" class="inline-flex p-4 text-orange-600 border-b-2 border-orange-600 rounded-t-lg active dark:text-orange-500 dark:border-orange-500 group" aria-current="page">
                    ...
                    <li class="mr-2">
                        <a href="{{ route('backend.invoice.entwurf.index') }}" class="inline-flex p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
                    ...
                    <x-ag.table.tr class="text-sm">
                        ...
                        <td class="p-2 cursor-pointer" wire:click="show({{ $invoice->order_nr }})">
                            <x-ag.badge color="blue" style="display: inline-flex; align-items: center;">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 mr-2" fill="currentColor" viewBox="0 0 512 512"><path d="M352 320c88.4 0 160-71.6 160-160c0-15.3-2.2-30.1-6.2-44.2c-3.1-10.8-16.4-13.2-24.3-5.3l-76.8 76.8c-3 3-7.1 4.7-11.3 4.7H336c-8.8 0-16-7.2-16-16V118.6c0-4.2 1.7-8.3 4.7-11.3l76.8-76.8c7.9-7.9 5.4-21.2-5.3-24.3C382.1 2.2 367.3 0 352 0C263.6 0 192 71.6 192 160c0 19.1 3.4 37.5 9.5 54.5L19.9 396.1C7.2 408.8 0 426.1 0 444.1C0 481.6 30.4 512 67.9 512c18 0 35.3-7.2 48-19.9L297.5 310.5c17 6.2 35.4 9.5 54.5 9.5zM80 408a24 24 0 1 1 0 48 24 24 0 1 1 0-48z"/></svg>Auftrag
                            </x-ag.badge>
                        </td>
