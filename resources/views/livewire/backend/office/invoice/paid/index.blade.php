        ...
        <div class="w-full mb-1">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 mb-4">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                    ...
                    <li class="mr-2">
                        <a href="{{ route('backend.invoice.bezahlt.index') }}" class="inline-flex p-4 text-orange-600 border-b-2 border-orange-600 rounded-t-lg active dark:text-orange-500 dark:border-orange-500 group" aria-current="page">
