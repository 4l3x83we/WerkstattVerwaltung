        ...
        <div class="w-full">
            <div class="breadcrumbs mb-4">
                ...
                <div class="inline-flex items-center">
                    <h1 class="text-xl font-semibold text-gray-900 lg:text-2xl dark:text-white mr-4">Aufträge</h1>
            ...
            <div class="lg:flex">
                <div class="items-center flex">
                    @can('create')
                        ...
                        @if(count($invoices) > 0)<div class="ml-4"> {{ $invoices->count() }} @if(count($invoices) === 1) Auftrag @else Aufträge @endif </div>@endif
                    @endcan
                </div>
