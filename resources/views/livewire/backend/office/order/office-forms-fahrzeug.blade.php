    ...
    <x-ag.card.head>
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 sm:col-span-6">
                <x-ag.forms.inline-label-input type="date" id="orders.delivery_performance_date" text="Liefer-/ Leistungsdatum"/>
            </div>
            <div class="col-span-12 sm:col-span-6">
                <x-ag.forms.inline-select id="orders.order_payment" text="Zahlungsbedingungen">
            ...
            <div class="col-span-12 sm:col-span-6">
                <x-ag.forms.inline-select id="orders.order_order_type" text="Auftragsart">
            ...
            <div class="col-span-12 sm:col-span-6">
                <x-ag.forms.inline-select id="orders.order_clerk" text="Sachbearbeiter/in">
