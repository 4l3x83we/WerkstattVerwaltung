<x-ag.card.head>
    <h3 class="mb-4 text-xl font-semibold dark:text-white">Fahrzeughersteller Import</h3>
    @can('create')
        <form action="{{ route('backend.fahrzeuge.brands.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
