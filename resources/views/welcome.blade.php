...
<div class="relative lg:flex lg:justify-center lg:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
    <x-ag.errors.errorMessages />
    @if (Route::has('login'))
        <div class="lg:fixed lg:top-0 lg:right-0 p-6 text-right z-10">
            @auth
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        ...
        <div class="flex justify-center mt-16 px-0 lg:items-center lg:justify-between">
            <div class="text-center text-sm text-gray-500 dark:text-gray-400 lg:text-left">
            ...
            <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 lg:text-right lg:ml-0">
